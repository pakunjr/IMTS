...
class controller_documents {
    ...
    public function generateInventoryReport ($ownerType, $ownerId) {
        ...
        $this->mPDF->SetHTMLFooter('<div id="pdf-footer">
            <div class="hr"></div>
            Generated by '.$docGenerator.' as of '.$fx->dateToWords(date('Y-m-d')).' @ '.date('H:i:s').'<br />
            Page {PAGENO} of {nbpg}, Inventory report of items owned by '.$c_owners->displayOwnerName($datas['ownership_id'], false).'<br />
            </div>');
